 ...
 * Plugin for jQuery
 * v0.0
 * ==formValidator plugin==
 *
 * By jp Guilleron
 *
 * Please use as you wish at your own risk.
 * @see https://openclassrooms.com/courses/developpez-votre-propre-plug-in-jquery
 * @see http://www.jquery.info/spip.php?article92
 */
 ...
 *     where:
 *       <select> is the DOM node selector, like "p"
 *       <value1> is the first parameter(optional) default="none"
 *       <value2> is the second parameter(optional) default="none"
 * 		"callback" function to be called at the end of the execution
 */
...
(function($) { 
    $.fn.formValidator=function() {      
      return this.each(function() {
    	   /**
    	    * tooltips are displayed only in case of error
    	    */
    	  function getTooltip(element) {
		   ...
		   (function() { 
		   	...
		   	console.log("myForm[0].action=" + myForm[0].getAttribute('action'));
		   ...
		   console.log('formValidator.js, events loaded.' + Date() );
	    });      // function closure                         
