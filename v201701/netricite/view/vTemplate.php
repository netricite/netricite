...
<meta property="og:url"
	content="http://local.netricite.com/netricite/v2016-14/index.php" />
<meta property="og:type" content="website" />
<meta property="og:title" content="Le Traineau - LES GETS" />
<meta property="og:description" content="Epicerie fine" />
<meta property="og:image"
	content="http://local.netricite.com/netricite/v2016-14/public/img/leTraineau/logo-leTraineau.png" />

<meta name="google-signin-client_id"
	content="530780569881-5ndq0508il1k82qjpp4ttvo9uaqmak4i.apps.googleusercontent.com" />
...
<link href="public/css/style.css?d=<?php echo date('dm'); ?>"
	rel="stylesheet" />
<link href="public/css/test.css?d=<?php echo date('dm'); ?>"
	rel="stylesheet" />
...
<link rel="shortcut icon" type="image/x-icon"
	href="public/img/leTraineau/savoie.svg" />
...
<script src="public/js/helper.js?d=<?php echo date('dm'); ?>"></script>
...
function statusChangeCallback(response) {
  ...
  if (response.status === 'connected') {
    ...
    document.getElementById('fbstatus').innerHTML = 'Veuillez vous logger ' + 'sur votre application';
  } else {
    // The person is not logged into Facebook, so we're not sure if
    // they are logged into this app or not.
    document.getElementById('fbstatus').innerHTML = 'Veuillez vous logger ' + 'sur Facebook.';
  }
}
...
$time = microtime(TRUE);
$cachename = "netricite/view/vfooter.php";
$cache->requireFile($cachename);
$duration = round(microtime(TRUE) - $time, 6);
echo "<p>" . $duration . "sec.</p>";
// watch("cached execution(" . $form . ")" . $duration . " sec", "", "vTemplate");
...
?>
	...
	<script type="text/javascript"
		src="public/js/fnformValidator.js?d=<?php echo date('dm'); ?>"></script>
	<script type="text/javascript"
		src="public/js/GoogleAuth.js?d=<?php echo date('dm'); ?>"></script>

	<!-- Javascript - embeded applications -->
	<script type="text/javascript"
		src="public/js/bootstrap-rating.min.js?d=<?php echo date('dm'); ?>"></script>
