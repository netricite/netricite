...
if (! $cache->start($cachename)) {
	...
	<section class="col-sm-8">
		...
		<article id="home" class="container-fluid">
			...
			<h3 class="text-center">
				Promotions du jour<span class="label label-warning">Nouveau!!!</span>
			</h3>
			...
			<h3 class="text-center">
				Promotions des fêtes de fin d'année<span class="label label-default">Nouvel
					arrivage!</span>
			</h3>
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
			tristique justo eu sollicitudin pretium. Nam scelerisque arcu at dui
			...
			<div class="panel-body" id="img-content">
				...
				<?php
    echo $this->formgen->imageLink(array(
        "col" => "1",
        "file" => "assiette-huitre.jpg",
        "legend" => "Nos assiettes d'huitres",
    ...
    echo $this->formgen->imageLink(array(
        "col" => "3",
        "file" => "saucisson-tranche.jpg",
        "legend" => "Charcuterie de Savoie",
        "link" => "Voir les produits",
    ...
    echo $this->formgen->imageLink(array(
        "col" => "3",
        "file" => "fromages-vitrine.jpg",
        "legend" => "Nos fromages AOP",
        "link" => "Voir les produits",
    ...
    echo $this->formgen->imageLink(array(
        "col" => "3",
        "file" => "verre-vin.jpg",
        "legend" => "Notre sélection de vins",
        "link" => "Voir les produits",
    ...
    ?>
		...
		<article id="services" class="container-fluid">
			<header class="panel-heading">
				<h1 class="text-center">Une gamme de produits de qualité et de
					services personnalisés</h1>
			</header>
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
			tristique justo eu sollicitudin pretium. Nam scelerisque arcu at dui
			porttitor, non viverra sapien pretium. Nunc nec dignissim nunc. Sed
    ...
    ?>
		...
		<article id="contact" class="container-fluid">
			...
			<div class="tab-content">
				<div id="tab0" class="tab-pane fade in active">
					...
					<div class="item">
						<img class="img-responsive img-thumbnail"
							src="public/img/leTraineau/Audrey-Damien-Charlotte.jpg" alt="Vin"
				...
				<div id="tab2" class="tab-pane fade">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
						...
						odio orci rhoncus metus.</p>
					<img class="img-responsive img-thumbnail"
						src="public/img/leTraineau/letraineau-damien-audrey.jpg" alt="Vin"
						style="width: 304px; height: 228px;">
			...
			<div class="row">
				...
				<p class="text-center">
					<em>Nous vous adorons!</em>
				</p>
				<div class="col-md-6">
					<p>
						<span class="glyphicon glyphicon-map-marker"></span>Les Gets,
						France - 74260
					</p>
					<span class="glyphicons glyphicons-global"></span><a
						href="http://www.letraineau-lesgets.com/">http://www.letraineau-lesgets.com/</a>
					</p>
				</div>
				<div class="col-md-6">
					<p>
						<span class="glyphicon glyphicon-phone"></span>+0033(6)45861562
					</p>
					<p>
						<span class="glyphicon glyphicon-envelope"></span>audrey_guilleron@hotmail.com
					</p>
				</div>
			</div>
			<!-- end row -->
...
$this->logger->addInfo("cached execution(" . $cachename . ")" . $duration . " sec");
...
echo $this->formgen->button(array(
    "field" => "add",
    "col" => "6",
    "icon" => "ok",
		...
		<article id="about" class="container-fluid">
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<p>
						Suivez nous sur face book <a
							href="https://www.facebook.com/letraineaulesgets/?fref=ts">Rejoignez
							nous</a>
					</p>
					<p>
						ment participatif, grâce au site "Bulb in Town", nous avons lancé
						notre projet, <a
							href="https://coupdenvoi.societegenerale.fr/les-projets/le-traineau---produits-regionaux-et-epicerie-fine-2271">Rejoignez
							nous</a>
					</p>
					<button class="btn btn-default btn-lg">
						<a href="#contact">Restons en contact</a>
					</button>
				</div>
				<div class="col-sm-4">
					<img class="img-logo-small img-responsive"
						src="public/img/leTraineau/logo-letraineau.png" alt="Le Traineau">
				</div>
			</div>
			<aside class="container-fluid bg-grey">
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<h3>NOTRE MISSION</h3>
						<p>
							<strong>Nous croyons que nos clients </strong>lorem ipsum dolor
							sit amet, consectetur adipiscing elit. Proin tristique justo eu
							sollicitudin pretium. Nam scelerisque arcu at dui porttitor, non
							viverra sapien pretium. Nunc nec dignissim nunc. Sed eget est
							purus. Sed convallis, metus in dictum feugiat, odio orci rhoncus
							metus. <a href="#">Read more</a>
						</p>
						<h3>NOTRE VISION</h3>
						<p>
							<strong>Notre vision de l'alimentation d'aujourd'hui</strong>
							lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
							tristique justo eu sollicitudin pretium. Nam scelerisque arcu at
							dui porttitor, non viverra sapien pretium. Nunc nec dignissim
							nunc. Sed eget est purus. Sed convallis, metus in dictum feugiat,
