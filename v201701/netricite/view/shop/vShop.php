  ...
  <article class="row">
    ...
    <nav class="col-sm-2" id="myScrollspy">
      <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="205">    
        ...
        <li><a href="index.php?application=shop&class=shop#section4">EPICERIE FINE</a></li>
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <!--  $this->formgen->image(array("file"=>"saucisson-tranche.jpg", "class"=>"img-thumbnail", "boxsize"=>500)); ?> -->
                  <img src="public/img/leTraineau/saucisson-tranche.jpg" alt="Charcuterie" class="img-thumbnail" >  
              ...
              <div class="item">
                <img src="public/img/leTraineau/fromages-vitrine.jpg" alt="Fromage" class="img-thumbnail" >
                <div class="carousel-caption">
              ...
              <div class="item">
                <img src="public/img/leTraineau/verre-vin.jpg" alt="Vin" class="img-thumbnail">
                <div class="carousel-caption">
              ...
              <div class="item">
                <img src="public/img/leTraineau/assiette-huitre.jpg" alt="huitres" class="img-thumbnail" >
                <div class="carousel-caption">
        			
        			<p>Des huitres Médaille d'or, Arrivage direct du morbihan (Bretagne).</p>
      			</div>
              </div>
            </div>
        ...
        for ($i = 0; $i < $count; $i+=$nbColumn) {
            for ($col = 0; $col < $nbColumn; $col++) {
                if ($i+$col<$count) {
                    ...
                    $fieldList=array(htmlutf8($data[$i+$col]['unitPrice']). ".- &euro;",
                            htmlutf8($data[$i+$col]['name']) , 
                            htmlutf8($data[$i+$col]['description'])
                            );
        
                    echo $this->formgen->imageCart(array("col"=>"4", "file"=>$data[$i+$col]['imgLink'],
                        "id"=>$data[$i+$col]['id'], "title"=>htmlutf8($data[$i+$col]['shortname']),
        ...
        for ($i = 0; $i < $count; $i+=$nbColumn) {
            ...
            for ($col = 0; $col < $nbColumn; $col++) {
                if ($i+$col<$count) {
                    ...
                    echo $this->formgen->imageCart(array("id"=>$data[$i+$col]['id'], 
                        "col"=>"4", "file"=>$data[$i+$col]['imgLink'], 
            ...
            <div class="tab-content">
              <div id="tab0" class="tab-pane fade in active">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
                        ...
                        <div class="thumbnail">
                    		<img class="img-medium" src="public/img/leTraineau/assiette-huitre.jpg" alt="Paris" >
                    		<p><strong>Savoie pur porc</strong></p>
                    	</div>		
              ...
              <div id="tab1" class="tab-pane fade">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
						...
						odio orci rhoncus metus.</p>
						<div class="thumbnail">
                    		<img class="img-medium" src="public/img/leTraineau/saumon.jpg" alt="Paris" >
                    		<p><strong>Savoie pur porc</strong></p>
                    	</div>	
              </div>
              ...
              <div id="tab2" class="tab-pane fade">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
						...
						odio orci rhoncus metus.</p>
						<div class="thumbnail">
                    		<img class="img-medium" src="public/img/leTraineau/escargot.jpg" alt="Paris" >
                    		<p><strong>Savoie pur porc</strong></p>
                    	</div>	
              </div>
              <div id="tab3" class="tab-pane fade">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
						...
						odio orci rhoncus metus.</p>
						<div class="thumbnail">
                    		<img class="img-medium" src="public/img/leTraineau/verre-vin.jpg" alt="Paris" >
                    		<p><strong>Savoie pur porc</strong></p>
                    	</div>
               </div>	
...
?>
        ...
        <article id="section5" class="container-fluid">
            ...
            echo $this->formgen->formbegin(array("name"=>"formContact", "legend"=>"Vous pouvez réserver 3 jours à l'avance."),  
                array("application"=>"shop","class"=>"shop"), 
                array("post"=>"", "comment"=>"", "user"=>"", "date_created"=>"", "postid"=>"", "count"=>"1", "booking"=>"", "fondue"=>"", "raclette"=>"", "huitre"=>""));
            
            echo $this->formgen->imageThumbnail(array("col"=>"4", "file"=>"fondue.jpg", "title"=>"Fondue(par personne)", 
                "legend"=>$this->formgen->checkbox( "-inline","fondue","", array("fondue"=>"Fondue") ) ) );
            echo $this->formgen->imageThumbnail(array("col"=>"4", "file"=>"verre-vin.jpg", "title"=>"Raclette(par personne)",
                "legend"=>$this->formgen->checkbox( "-inline","raclette","", array("raclette"=>"Raclette") ) ) );
            echo $this->formgen->imageThumbnail(array("col"=>"4", "file"=>"assiette-huitre.jpg", "title"=>"Huitres(à la douzaine)",
                "legend"=>$this->formgen->checkbox( "-inline","huitre", "", array("huitres"=>"Huitres") ) ) );
            ...
            echo $this->formgen->input(array("type"=>"email", "col"=>"12", "field"=>"user", "placeholder"=>"votre email", "icon"=>"envelope", "errortext"=>"email address, format: name@example.com",
                    "tooltip"=>"format: name@example.com",
                    "attr"=>array("required" => "required")
                    ));
            //echo $this->formgen->input("user", "", "Entrez votre email","12","eMail", "" ,array("required" => "required"));
            echo $this->formgen->textarea(array("field"=>"comment", "placeholder"=>"Votre commentaire", "label"=>"commentaire",
            ...
            echo $this->formgen->input(array("field"=>"count", "label"=>"nombre de personnes/douzaine d'huitres", "errortext"=>"saisie invalide",
                "tooltip"=>"format: name@example.com" ));
            //echo $this->formgen->input("count","", "","","nombre de personnes/douzaine d'huitres");
            
            echo $this->formgen->divbegin("6");
            echo $this->formgen->checkbox("","booking","", array("appareil"=>"Je réserve aussi un appareil (Fondue/Raclette)"));
            ...
            echo $this->formgen->buttonSession(array("field"=>"add","col"=>"12","icon"=>"ok","text"=>"Réservez maintenant"));
            /*
            ...
            */
        	...
        	<aside class="container-fluid bg-grey">
        		<p>Préciser le produit et le nombre de parts. 
            	nous mettons à votre disposition les appareils à fondue et à raclette (1 appareil pour 6 personnes).</p>
    ...
    <!-- Container (Section6) -->
        <article id="section6" class="container-fluid">
