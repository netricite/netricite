...
?>
<ul id='sortable__index' class='sortable'>
<?php
$i = 0;
foreach ($classes as $record) {
    ...
    <div class="col-xs-2 col-sm-2">
		<li id="<?= $record['type'] ?>"><span
			class="glyphicon glyphicon-menu-hamburger"><?=$record['type'] ?></span>
		</li>
	</div>
    <?php
}
...
echo $this->formgen->rowbegin();
// FORM TODO TASK LIST
// @todo bug sur le click des categories
// TODO bug sur le click des categories
...
foreach ($records as $record) {
    ...
    echo '<span class="glyphicon glyphicon-menu-hamburger">==== tache n. ' . $record['id'] . '</span>';
    ...
    echo $this->formgen->inputDate(array(
        "field" => "milestone",
        "index" => $i,
        "col" => "2",
        "tooltip" => "délai"
