...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php?application=root&class=root"><img
				class="img-logo-small img-responsive"
				src="public/img/leTraineau/savoie.svg" alt="Le Traineau"></a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">Applications <span class="caret"></span></a>
    ...
    echo $this->formgen->iconHref(array(
        'index' => 'index.php?application=shop&class=cart',
        'icon' => "shopping-cart",
        'tooltip' => "Ajouter au panier",
        'legend' => array_sum($_SESSION['cart']),
        'id' => "cartItemsCount"
    ));
    ?></li>
...
?>
        <li><a id="signoff"
					href="index.php?application=login&class=login<?=$action?> "
					<?=$onclick?>><span class="glyphicon glyphicon-user"><?=$login?></span></a></li>
