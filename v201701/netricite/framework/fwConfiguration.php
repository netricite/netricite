...
class fwConfiguration
{
    ...
    public static function get($param, $defaultValue = null)
    {
        if (isset(self::$config[$param])) {
            ...
            // watch(array("key"=>$param, "value"=>$value), ".get", get_class());
        } else {
    ...
    public static function getConfigClass($class)
    {
        ...
        watch($config, "fwConfiguration.get.getConfigClass");
        return $config;
    }
    ...
    public static function getConfig($inifile = "")
    {
        if (empty(self::$config)) {
            ...
            if (! file_exists($inifile)) {
                ...
                watch(self::$config, $inifile, get_class());
            }
        }
        return self::$config;
    }
