...
abstract class fwControler
{
    ...
    {       
        fwWatch($request->parameters, "setRequest(url parameters)", get_class($this));
    ...
    public function index() {
        ...
        else    $this->generateView(array());           //no data
    }
    ...
    {
        //fwTrace(debug_backtrace(),$data );
        fwTrace(debug_backtrace(),array("#records" =>  count($data)) );
    ...
    protected function redirect($application, $class, $action = null)
    {
        ...
        if (!$application=="")  {
            ...
            fwWatch(array(
                'invalid application -> redirect(home)' => $application . "/" . $class ), "", get_class($this));
            $this->home();
        }
    }
    ...
    */
    public function uploadFile($filename) {
        ...
        $file_display = array('jpg', 'jpeg', 'png', 'gif', 'JPG', 'JPEG', 'PNG', 'GIF');
    ...
    public function forceLogin() {
        ...
        fwWatch(array("nextApplication"=>$this->application,
            "nextClass"=>$class), ".forceLogin", get_class($this));
